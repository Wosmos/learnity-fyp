...
import {
  AlertCircle, RefreshCw, BookOpen, FileText, Mail,
  Star, ArrowRight, Sparkles, Lightbulb, CheckCircle2,
  ShieldCheck, GraduationCap, Video, Award, Calendar
} from 'lucide-react';
...
export default function RejectedTeacherDashboard() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-slate-500 font-medium animate-pulse">Personalizing your growth plan...</p>
      </div>
    );
  }

  const rejectionReason = statusData?.rejectionReason || 'Application Under Review';
  ...
  const getFeedbackMessage = (reason: string) => {
    const feedbackMap: Record<string, string> = {
      'Incomplete Documentation': 'Your application was missing some required documents. Please ensure all certifications and qualifications are properly uploaded.',
      'Insufficient Experience': 'We require a minimum level of teaching experience. Consider gaining more experience or highlighting relevant experience you may have.',
      'Profile Incomplete': 'Your profile needs more information to help students understand your expertise. Please complete all required sections.',
      'Video Introduction Missing': 'A video introduction helps students connect with you. Please add a professional video introduction.',
      'Qualifications Not Verified': 'We were unable to verify your qualifications. Please ensure your documents are clear and valid.',
    };
    return feedbackMap[reason] || 'Please review the improvement areas below and resubmit your application when ready.';
  };
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <header className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
            While your current application wasn&apos;t approved, we see your potential. Use this feedback to strengthen your profile and join our elite educator community.
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <Card className="overflow-hidden border-none shadow-xl shadow-indigo-100/50 bg-white/80 backdrop-blur">
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    <CardTitle className="text-2xl font-bold text-slate-800">Reviewer Insights</CardTitle>
              ...
              <CardContent className="space-y-6">
                ...
                {improvementAreas.length > 0 && (
                  <div className="space-y-4">
                    <h4 className="text-sm font-bold uppercase tracking-wider text-slate-400">Step-by-Step Improvements</h4>
                  ...
                  <div className="pt-6 border-t border-slate-100">
                    <div className="flex flex-col md:flex-row items-center gap-6 bg-indigo-50/50 p-6 rounded-2xl ring-1 ring-indigo-100">
                      <div className="flex-1 text-center md:text-left">
                        <h4 className="text-lg font-bold text-indigo-900">Ready to try again?</h4>
                        <p className="text-sm text-indigo-700 mt-1">
                          {reapplyDate 
                            ? <>Apply anytime after <span className="underline font-bold">{reapplyDate}</span>.</>
                      ...
                      >
                        <RefreshCw className="mr-2 h-5 w-5" /> Start New Application
                      </Button>
                    </div>
                  </div>
                )}
          ...
          <aside className="lg:col-span-4 space-y-8">
            ...
            <Card className="bg-slate-900 text-white border-none shadow-2xl overflow-hidden relative">
              ...
              <CardContent className="p-8 space-y-6 relative z-10">
                <div className="space-y-2">
                  ...
                  <p className="text-slate-400 text-sm">Great teachers are built through persistence and constant learning.</p>
                </div>
                
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur">
                    <div className="text-2xl font-black text-indigo-400">85%</div>
                    <div className="text-[10px] uppercase font-bold text-slate-500 tracking-tighter">Re-apply success</div>
                  </div>
                  <div className="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur">
                    <div className="text-2xl font-black text-amber-400">24/7</div>
                    <div className="text-[10px] uppercase font-bold text-slate-500 tracking-tighter">Support Access</div>
                  </div>
                </div>
            ...
            {/* Support Options */}
            <div className="space-y-4">
              <h4 className="text-sm font-bold text-slate-500 uppercase px-2 tracking-widest">Need personalized help?</h4>
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">Send us your questions and concerns</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <Card className="border-none shadow-lg bg-gradient-to-br from-green-500 via-green-600 to-yellow-700 text-white">
              ...
              <CardContent>
                <p className="text-sm text-green-50 italic leading-relaxed">
                  &ldquo;I was rejected initially but used the feedback to improve. Now I&apos;m a top-rated teacher with 50+ students!&rdquo;
                </p>
                <div className="mt-4 flex items-center gap-3">
                  <div className="h-8 w-8 rounded-full bg-white/20" />
                  <span className="text-xs font-bold">Sarah M., Math Expert</span>
                </div>
              </CardContent>
            </Card>
          </aside>
        ...
        <div className="space-y-4 mt-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {improvementResources.map((res, i) => (
              <Card key={i} className="group hover:ring-2 hover:ring-indigo-500 transition-all cursor-pointer border-none shadow-lg">
                <CardContent className="p-4 flex gap-4">
                  ...
                  <div className="space-y-1">
                    <h4 className="font-bold text-slate-900 text-sm group-hover:text-indigo-600 transition-colors">{res.title}</h4>
