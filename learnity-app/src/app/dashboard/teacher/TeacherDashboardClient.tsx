...
export function TeacherDashboardClient({ displayName, stats, recentCourses, recentActivity }: Props) {
  return (
                    ...
                    <div className='space-y-4'>
                      {recentActivity.map(activity => (
                        <div key={activity.id} className='flex gap-3'>
                          <div className='shrink-0 pt-1'>{getActivityIcon(activity.type)}</div>
                          <div>
