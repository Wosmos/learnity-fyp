  ...
  const fetchAnalytics = useCallback(async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          data.error?.message || data.message || 'Failed to fetch analytics'
        );
      }
        ...
        {quizPerformance.totalQuizzes > 0 && (
          <Card className='border-0 shadow-md mb-8'>
            <CardHeader>
              ...
              <CardDescription>
                Overall pass rate: {quizPerformance.overallPassRate}% | Average
                score: {quizPerformance.overallAverageScore}%
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <tbody>
                    {quizPerformance.quizStats.map(quiz => (
                      ...
                      >
                        ...
                        <td className='py-3 px-4 text-sm text-center font-medium text-slate-900'>
                          {quiz.averageScore}%
                        </td>
                      </tr>
                    ))}
