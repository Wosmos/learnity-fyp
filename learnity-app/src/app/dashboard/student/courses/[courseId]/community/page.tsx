...
import {
  ...
  Loader2, AlertCircle, Clock, Play, Sparkles, Zap,
  LayoutDashboard, GraduationCap, Share2
} from 'lucide-react';
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-slate-500 font-medium animate-pulse">Entering community space...</p>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <Card className="max-w-md border-none shadow-xl">
          <CardContent className="flex flex-col items-center py-8 gap-4">
            ...
            <p className="text-slate-700 font-bold text-lg">Course content unavailable</p>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-8">
                  ...
                  {room?.chatEnabled ? (
                    ...
                    <Card className="border-dashed border-2 border-slate-200 bg-slate-50/50 shadow-none">
                      <CardContent className="flex flex-col items-center py-16 gap-6 text-center">
                        ...
                        <div>
                          <h3 className="text-xl font-bold text-slate-700">Chat Unavailable</h3>
                          <p className="text-slate-500 max-w-xs mx-auto mt-2">The discussion board for this course hasn't been enabled by your instructor yet.</p>
                        </div>
                      </CardContent>
                    </Card>
                  )}
                ...
                <TabsContent value="sessions" className="mt-0 focus-visible:ring-0 space-y-6">
                  ...
                  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 to-violet-700 text-white shadow-2xl shadow-indigo-200 p-8">
                    ...
                    <div className="relative z-10 space-y-4 max-w-xl">
                      <Badge className="bg-white/20 hover:bg-white/30 text-white border-0 backdrop-blur-sm">Interactive Learning</Badge>
                      <h2 className="text-3xl font-black tracking-tight">Virtual Classroom</h2>
                      <p className="text-indigo-100 text-lg leading-relaxed">
                        Join live sessions to interact with your instructor and classmates in real-time.
                        Ask questions, participate in discussions, and learn together.
                      </p>
                      {room?.videoEnabled && (
                        <Button
                          onClick={() => setShowVideoRoom(true)}
                      ...
                      <Card className="border-none shadow-lg bg-white/60 backdrop-blur">
                        <CardContent className="flex flex-col items-center py-12 gap-4 text-center">
                          ...
                          <div>
                            ...
                            <p className="text-slate-500">Check back later for upcoming live classes</p>
                          </div>
                        </CardContent>
                      </Card>
                    ) : (
                          ...
                          >
                            <div className="flex items-center gap-5">
                              <div className={cn(
                                ...
                                session.status === 'LIVE' ? "bg-red-50 text-red-600" : "bg-indigo-50 text-indigo-600"
                              )}>
                            ...
                            <div className="mt-4 md:mt-0 flex items-center gap-3 w-full md:w-auto">
                              {session.status === 'LIVE' ? (
                                ...
                                <Badge variant="secondary" className="px-3 py-1 bg-slate-100 text-slate-500">
                                  Scheduled
                                </Badge>
                              )}
                            </div>
                ...
                <Card className="bg-slate-900 text-white border-none shadow-2xl relative overflow-hidden rounded-3xl">
                  ...
                  <CardContent className="p-8 relative z-10 space-y-4">
                    <div className="flex items-center gap-2 text-amber-400 mb-2">
                      ...
                      <span className="text-xs font-black uppercase tracking-widest">Studymate AI</span>
                    </div>
                    <h3 className="text-xl font-bold">Stay Connected</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">
                      Engaging in community discussions can increase your retention rate by up to 60%. Don't be shy to ask!
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-lg shadow-indigo-100/20 rounded-3xl overflow-hidden bg-white/70 backdrop-blur">
                  ...
                  <CardContent className="p-6 space-y-4">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-900 text-sm">Be Respectful</h4>
                        <p className="text-xs text-slate-500 mt-1">Treat your peers and instructor with kindness and respect.</p>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-slate-900 text-sm">Stay on Topic</h4>
                        <p className="text-xs text-slate-500 mt-1">Keep discussions relevant to the course material.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-lg shadow-indigo-100/20 rounded-3xl overflow-hidden bg-white">
                  ...
                  <CardContent className="p-2">
                    ...
                    <Button
                      variant="ghost"
                      className="w-full justify-start h-12 rounded-xl text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 font-medium"
                      onClick={() => toast({ title: "Shared!", description: "Course link copied to clipboard" })}
                    >
