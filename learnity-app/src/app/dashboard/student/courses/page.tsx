          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <h1 className="text-3xl font-black text-slate-900 tracking-tight">
                  My Learning <span className="text-slate-400 font-light italic">Path</span>
                </h1>
                <p className="text-sm font-medium text-slate-500 max-w-md">
                  Continuity is key. You&apos;re currently making progress in <span className="text-indigo-600 font-bold">3 active courses</span>.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              <Link href="/dashboard/student/public-cources">
                <Button
                  className="h-12 px-6 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white shadow-lg shadow-slate-200 transition-all active:scale-95 flex items-center gap-2 group"
                >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-[10px] font-medium text-slate-400">modules</span>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className={cn(
                    ...
                    activeTab === tab.id ? "bg-indigo-50 text-indigo-600" : "bg-slate-200/50 text-slate-500"
                  )}>
                    {tab.count}
                  </span>
                </div>
