      ...
      <header className='pt-32 pb-16 px-4 md:px-6 max-w-[1600px] mx-auto'>
        <div className='text-center max-w-4xl mx-auto'>
          ...
          <p className='text-gray-400 text-lg mb-8 max-w-2xl mx-auto'>
            From <strong>Programming</strong> to <strong>Science</strong>.
      ...
      <section className='py-20 bg-linear-to-t from-emerald-500/10 to-transparent border-t border-white/5'>
        <div className='max-w-4xl mx-auto text-center px-4'>
          ...
          <p className='text-gray-400 mb-8'>
            Join thousands of students already learning on Learnity.
          </p>
      ...
      <footer className='border-t border-white/10 bg-black py-12'>
        <div className='max-w-[1600px] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6'>
          ...
          <div className='text-gray-500 text-sm'>
            © 2025 Learnity. All rights reserved.
          </div>
      ...
      <div className='relative h-[420px] rounded-2xl overflow-hidden border border-white/10 bg-[#050505] transition-all duration-300 hover:border-emerald-500/40 hover:bg-white/5'>
        ...
        <div className='relative h-48 overflow-hidden'>
          ...
          <div className='absolute top-3 left-3 flex gap-2'>
            <span
              className={`px-2 py-1 rounded-full text-xs font-bold border ${difficultyColorClasses[course.difficulty]}`}
            >
              {difficulty.label}
            </span>
          </div>
