 ...
 */
export default async function CertificateViewPage({ params }: CertificatePageProps) {
  ...
  const cert = certificate as typeof certificate & { certificateId: string; issuedAt: Date };
