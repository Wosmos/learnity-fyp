...
import { CertificatePage, CertificatePageProps } from "@/components/courses/CertificatePage";
import { useToast } from "@/hooks/use-toast";

interface CertificatePageClientProps extends Omit<CertificatePageProps, 'onDownload' | 'isDownloading'> {}
...
export function CertificatePageClient(props: CertificatePageClientProps) {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/certificates/${props.certificateId}/download`);
