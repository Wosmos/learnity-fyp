            ...
            >
              <div className='flex items-start space-x-2'>
                ...
                <div>
                  ...
                  {!result.success &&
                    result.message.includes('Firebase Admin SDK') && (
                      <div className='mt-2'>
                        <p className='text-xs text-red-700 mb-2'>
                          Firebase Admin SDK needs to be configured. Follow
                          these steps:
                        </p>
                        <ol className='text-xs text-red-700 space-y-1 list-decimal list-inside'>
                          <li>
                            Go to Firebase Console → Project Settings → Service
                            Accounts
                          </li>
                          <li>
                            Click "Generate new private key" and download the
                            JSON file
                          </li>
                        ...
                        <p className='text-xs text-red-700 mt-2'>
                          📖 See <code>FIREBASE_ADMIN_SETUP.md</code> for
          ...
          <div className='mt-6 space-y-4'>
            ...
            <div className='p-4 bg-slate-50 border border-blue-200 rounded-lg'>
              ...
              <ol className='text-xs text-blue-700 space-y-1 list-decimal list-inside'>
                ...
                <li>
                  Add credentials to .env.local (see FIREBASE_ADMIN_SETUP.md)
                </li>
