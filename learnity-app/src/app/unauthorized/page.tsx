...
import { AlertTriangle, Home, ArrowLeft, Shield, User, BookOpen, GraduationCap } from 'lucide-react';
...
export default function UnauthorizedPage() {
  ...
  const [attemptedResource, setAttemptedResource] = useState<string>('');
  const [userRole, setUserRole] = useState<UserRole | null>(null);

  useEffect(() => {
    // Get attempted resource from URL params or referrer
    const resource = searchParams.get('resource') || document.referrer || 'unknown resource';
    ...
    if (user && claims) {
      ...
      auditLogger.logAccessControlViolation(
        ...
        claims.role,
        resource,
        UserRole.ADMIN, // Default to admin for unknown resources
        'unauthorized_page_access'
      );
    }
  }, [user, claims, searchParams]);
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm text-gray-600 space-y-2">
              ...
              {attemptedResource && attemptedResource !== 'unknown resource' && (
