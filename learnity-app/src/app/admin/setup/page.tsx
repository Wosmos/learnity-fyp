      ...
      <div className='max-w-2xl mx-auto space-y-6'>
        <div className='text-center'>
          ...
          <p className='text-gray-600'>
            Promote a user to admin role for development
          </p>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>
            <strong>Development Only:</strong> This page is for development
            purposes only. Remove this endpoint before deploying to production.
          </AlertDescription>
        </Alert>
