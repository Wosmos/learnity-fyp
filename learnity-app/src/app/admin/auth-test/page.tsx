...
export default function AdminAuthTestPage() {
  const { user, loading, isAuthenticated, claims, error, refreshClaims } =
    useAuth();
      ...
      <div className='max-w-4xl mx-auto space-y-6'>
              ...
              <div className='space-y-3'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <Badge className='mt-1'>{claims.role}</Badge>
                  </div>
                  <div>
                    <p className='text-sm font-medium text-gray-500'>
                      Profile Complete
                    ...
                    <Badge
                      variant={claims.profileComplete ? 'default' : 'secondary'}
                    >
                  ...
                  <div>
                    ...
                    <p className='text-sm text-gray-900'>
                      {claims.lastLoginAt
                        ? new Date(claims.lastLoginAt).toLocaleString()
                        : 'Not set'}
                    </p>
                  </div>
                </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Complete authentication state (for debugging)
            </CardDescription>
          </CardHeader>
          <CardContent>
