              ...
              <div className='space-y-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      updateSetting('features', 'teacherApplications', checked)
                    }
                  />
                </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      updateSetting('features', 'studentProfiles', checked)
                    }
                  />
                </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      updateSetting('features', 'messaging', checked)
                    }
                  />
                </div>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      updateSetting('features', 'videoSessions', checked)
                    }
                  />
                </div>
              </div>
