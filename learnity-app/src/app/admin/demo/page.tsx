      ...
      <div className='space-y-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              This demo generates test audit events to showcase the audit
              logging system. Click the button below to generate sample events,
              then view them in the Audit Logs section.
            </CardDescription>
          </CardHeader>
          <CardContent>
