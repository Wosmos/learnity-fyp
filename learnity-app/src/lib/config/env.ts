...
const envSchema = z.object({
  ...
  // hCaptcha
  NEXT_PUBLIC_HCAPTCHA_SITE_KEY: z
    .string()
    .min(1, 'NEXT_PUBLIC_HCAPTCHA_SITE_KEY is required'),
  HCAPTCHA_SECRET_KEY: z.string().min(1, 'HCAPTCHA_SECRET_KEY is required'),

  // Static Admin
  STATIC_ADMIN_EMAIL: z
    .string()
    .email('STATIC_ADMIN_EMAIL must be a valid email'),
  STATIC_ADMIN_PASSWORD: z
    .string()
    .min(8, 'STATIC_ADMIN_PASSWORD must be at least 8 characters'),
  // App Configuration
  NODE_ENV: z
