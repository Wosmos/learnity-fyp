...
// Admin Schemas
export const teacherApprovalSchema = z
  .object({
...
export const enhancedTeacherRegistrationSchema = z
  .object({
    // Basic Information
    firstName: z
      .string()
  ...
  .refine(
    ...
    {
      message:
        'Minimum session length cannot be greater than maximum session length',
...
export type EnhancedTeacherRegistrationData = z.infer<
...
export type StudentProfileEnhancementData = z.infer<
  typeof studentProfileEnhancementSchema
>;
export type TeacherApplicationUpdateData = z.infer<
  typeof teacherApplicationUpdateSchema
>;
