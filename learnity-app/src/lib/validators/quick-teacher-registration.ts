...
export const quickTeacherRegistrationSchema = z.object({
  ...
  agreeToBackgroundCheck: z.boolean()
    .refine(val => val === true, 'You must consent to background verification'),
...
export type QuickTeacherRegistrationData = z.infer<typeof quickTeacherRegistrationSchema>;
...
export const teacherProfileEnhancementSchema = z.object({
  ...
  // Contact Preferences
  communicationPreference: z.enum(['Email', 'Phone', 'Text', 'Video Call']).optional(),
...
export type TeacherProfileEnhancementData = z.infer<typeof teacherProfileEnhancementSchema>;