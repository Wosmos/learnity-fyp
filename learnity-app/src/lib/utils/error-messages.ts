...
export function getAuthErrorMessage(errorCode: string): ErrorMessage {
  switch (errorCode) {
    ...
    case 'auth/weak-password':
      return {
        title: 'Weak Password',
        description: 'Your password must be at least 6 characters long and include a mix of letters and numbers.',
        variant: 'destructive'
      };
    ...
    case 'auth/account-exists-with-different-credential':
      return {
        ...
        description: 'An account already exists with this email using a different sign-in method. Please use your original sign-in method.',
        variant: 'destructive'
      };
    ...
    case 'auth/invalid-credential':
      return {
        ...
        description: 'The credentials provided are invalid or have expired. Please try again.',
        variant: 'destructive'
      };
    ...
    case 'auth/popup-blocked':
      return {
        title: 'Popup Blocked',
        description: 'Please allow popups for this site to sign in with social providers.',
        variant: 'warning'
      };
    ...
    case 'auth/requires-recent-login':
      return {
        ...
        description: 'This operation requires recent authentication. Please sign in again.',
        variant: 'warning'
      };
    ...
    case AuthErrorCode.ACCOUNT_LOCKED:
      return {
        ...
        description: 'Your account has been locked due to suspicious activity. Please contact support.',
        variant: 'destructive'
      };
    ...
    case AuthErrorCode.ROLE_NOT_APPROVED:
      return {
        ...
        description: 'Your account is pending approval. You\'ll be notified once it\'s reviewed.',
        variant: 'warning'
      };
    ...
    case AuthErrorCode.RATE_LIMIT_EXCEEDED:
      return {
        ...
        description: 'Too many requests. Please slow down and try again in a few moments.',
        variant: 'destructive'
      };
