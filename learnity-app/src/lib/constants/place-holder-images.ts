export const PLACEHOLDER_IMAGES = [
  ...
  // 2. Modern & Sleek Study Workspaces
  ...
  'https://images.unsplash.com/photo-1454165833767-02a6ed8a6874?q=80&w=1200&auto=format&fit=crop',

  // 3. Creative & Academic Focus
