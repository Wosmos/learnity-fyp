...
const themeStyles: Record<ThemeColor, { 
  ...
  blue: { accent: 'text-blue-600', bg: 'bg-blue-50/50', border: 'border-blue-100', glow: 'shadow-blue-500/5' },
  purple: { accent: 'text-purple-600', bg: 'bg-purple-50/50', border: 'border-purple-100', glow: 'shadow-purple-500/5' },
  emerald: { accent: 'text-emerald-600', bg: 'bg-emerald-50/50', border: 'border-emerald-100', glow: 'shadow-emerald-500/5' },
  orange: { accent: 'text-orange-600', bg: 'bg-orange-50/50', border: 'border-orange-100', glow: 'shadow-orange-500/5' },
  rose: { accent: 'text-rose-600', bg: 'bg-rose-50/50', border: 'border-rose-100', glow: 'shadow-rose-500/5' },
  gray: { accent: 'text-slate-600', bg: 'bg-slate-50/50', border: 'border-slate-100', glow: 'shadow-slate-500/5' },
};
...
export function FeatureGrid({
  ...
  return (
    <div className={cn(
      ...
      columns === 3 ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4',
      className
    )}>
