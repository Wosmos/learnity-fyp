...
export function VideoSection({
  ...
  return (
    <section className={cn('py-10 bg-white relative overflow-hidden', className)}>
                  ...
                  placeholder || (
                    <div className="absolute inset-0 flex items-center justify-center bg-[#0a0c10]">
                      ...
                      <div className="relative text-center">
                        ...
                        <h4 className="text-xl font-black uppercase italic tracking-tighter text-white">Initialize Briefing</h4>
                        <p className="text-[10px] text-slate-500 uppercase tracking-[0.4em] mt-2 font-bold">Duration: 02:40 / 4K_UHD</p>
                      </div>
                    </div>
                  )
                )}
