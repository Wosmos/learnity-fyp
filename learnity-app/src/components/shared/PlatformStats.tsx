...
function isDetailedStats(
  stats: PlatformStatsType | DetailedStats
): stats is DetailedStats {
  ...
  const baseStatItems = [
    {
      ...
      trendValue:
        showTrends && isDetailedStats(stats)
          ? formatTrend(stats.trends.studentGrowthRate).value
          : '+12%',
    ...
    },
    {
      ...
      trendValue:
        showTrends && isDetailedStats(stats)
          ? formatTrend(stats.trends.teacherGrowthRate).value
          : '+8%',
      trendLabel: 'this month',
      icon: GraduationCap,
      ...
      ? [
          {
            ...
            trendValue:
              showTrends && isDetailedStats(stats)
                ? `+${stats.recentActivity.lessonsCompletedThisWeek}`
                : '+234',
