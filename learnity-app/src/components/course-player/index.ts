...
export type { LessonSidebarProps, LessonItem, SectionItem } from './LessonSidebar';

export { LessonCompleteDialog, XPCelebration } from './LessonCompleteDialog';
export type { LessonCompleteDialogProps, XPCelebrationProps } from './LessonCompleteDialog';
