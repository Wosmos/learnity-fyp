  ...
  return (
    <div className="flex-1 p-8 space-y-10 animate-pulse">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="h-32 rounded-[2rem] bg-slate-100 border border-slate-200/50 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="space-y-3">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-14 rounded-2xl bg-slate-50 border border-slate-100" />
            ))}
          </div>
        </div>
      </div>
