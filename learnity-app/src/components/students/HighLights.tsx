...
import { Trophy, Star, Target, Users, ShieldCheck, ArrowRight } from 'lucide-react';
import { Button } from '../ui/button';
import { cn } from '@/lib/utils';

export default function HighLights() {
    const achievements = [
        { title: "Math Master", progress: 100, icon: Star, color: "text-amber-500", bg: "bg-amber-500/10", border: "border-amber-500/20" },
        { title: "Goal Crusher", progress: 65, icon: Target, color: "text-blue-500", bg: "bg-blue-500/10", border: "border-blue-500/20" },
                ...
                {achievements.map((ach, i) => (
                    <motion.div
                        ...
                        className={cn(
                            ...
                            ach.progress === 100 ? "border-amber-100 shadow-sm" : "border-slate-100"
                        )}
                    >
                        {/* Status Indicator */}
                        ...
                        <div className="flex flex-col items-left text-left space-y-4">
                            ...
                            <div className="w-full space-y-2">
                                <div className="flex justify-between items-center text-[9px] font-black px-1">
                                    ...
                                    <span className={cn(ach.progress === 100 ? "text-emerald-600" : "text-indigo-600")}>
                                        {ach.progress}%
                                    </span>
                                </div>
