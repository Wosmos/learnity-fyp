...
const Footer = () => {
    return (
        <div> {/* 3. AI FOCUS SUGGESTION - REFINED ELEGANCE */}
            <div className="relative p-8 rounded-2xl bg-[#0F172A] overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-8">
                    ...
                    <div className="space-y-1 flex-1">
                        <h4 className="font-black text-xl text-white tracking-tight">Intelligence Optimization</h4>
                        <p className="text-slate-400 text-sm font-medium leading-relaxed">
                            Based on quiz patterns, accelerating <span className="text-indigo-400 font-bold">Chapter 6</span> now will optimize your mastery score by <span className="text-emerald-400">+15%</span>.
                        </p>
                    </div>
