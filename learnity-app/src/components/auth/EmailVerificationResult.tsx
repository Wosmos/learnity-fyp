...
export const EmailVerificationResult: React.FC<EmailVerificationResultProps> = ({
  success,
  userRole,
  error,
  onContinue,
    ...
    switch (userRole) {
      case UserRole.STUDENT:
        return {
          ...
          description: 'Welcome to Learnity! Your student account is now active.',
          nextSteps: [
      ...
      case UserRole.TEACHER:
        return {
          title: 'Email Verified Successfully!',
          description: 'Your email is verified. We\'re now reviewing your teacher application.',
          nextSteps: [
    ...
    <div className={`w-full max-w-2xl mx-auto p-6 ${className}`}>
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Troubleshooting */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Possible Solutions:</h3>
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Check if the verification link has expired (links are valid for 24 hours)
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="flex-shrink-0 w-6 h-6 rounded-full bg-gray-600 flex items-center justify-center text-xs font-medium text-white">
