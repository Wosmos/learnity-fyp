...
import {
  enhancedTeacherRegistrationSchema,
  type EnhancedTeacherRegistrationData,
...
const COMMUNICATION_PREFERENCES = ['Email', 'Phone', 'Text', 'Video Call'];
...
> = ({ onSubmit, onBack, className = '' }) => {
  ...
  const handleSubmit = async (data: EnhancedTeacherRegistrationData) => {
    ...
    try {
      ...
      if (profilePicture) {
        try {
          const result = await uploadToVercelBlob.uploadProfilePicture(
            profilePicture,
            'temp-' + Date.now()
          );
          ...
          if (!result.url) {
            console.warn(
              'Profile picture upload skipped - Vercel Blob not configured'
            );
          }
        } catch (error) {
          ...
          toast({
            ...
            description:
              'Profile picture upload failed, but application will continue.',
            variant: 'destructive',
          });
        }
      }
      ...
      if (bannerImage) {
        try {
          const result = await uploadToVercelBlob.uploadBannerImage(
            bannerImage,
            'temp-' + Date.now()
          );
          ...
          if (!result.url) {
            console.warn(
              'Banner image upload skipped - Vercel Blob not configured'
            );
          }
        } catch (error) {
          ...
          toast({
            title: 'Upload Warning',
            description:
              'Banner image upload failed, but application will continue.',
            variant: 'destructive',
          });
        }
      }
      ...
      if (videoIntro) {
        try {
          const result = await uploadToVercelBlob.uploadVideoIntro(
            videoIntro,
            'temp-' + Date.now()
          );
          ...
          if (!result.url) {
            console.warn(
              'Video introduction upload skipped - Vercel Blob not configured'
            );
          }
        } catch (error) {
          ...
          toast({
            title: 'Upload Warning',
            description:
              'Video introduction upload failed, but application will continue.',
            variant: 'destructive',
          });
        }
      }
      ...
      for (const file of uploadedFiles) {
        try {
          const result = await uploadToVercelBlob.uploadDocument(
            file,
            'temp-' + Date.now()
          );
          if (result.url) {
            ...
            console.warn(
              `Document upload skipped for ${file.name} - Vercel Blob not configured`
            );
          }
        } catch (error) {
      ...
      toast({
        ...
        description:
          "Your teacher application has been submitted successfully. You'll receive an email confirmation shortly.",
      });
  ...
  const handleArrayFieldToggle = (
    fieldName: keyof EnhancedTeacherRegistrationData,
    value: string,
    checked: boolean
  ) => {
    ...
    form.setValue(
      fieldName,
      newValues as EnhancedTeacherRegistrationData[typeof fieldName]
    );
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Minimum 50 characters. This will be visible to
                            students.
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={() => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Select all age groups you&apos;re comfortable
                            teaching
                          </FormDescription>
                          <div className='grid grid-cols-2 md:grid-cols-3 gap-3 mt-2'>
                ...
                <TabsContent value='media' className='space-y-6'>
                  <div className='space-y-4'>
                        ...
                        <div className='flex items-start gap-3'>
                          ...
                          <div>
                            ...
                            <p className='text-sm text-yellow-700 mt-1'>
                              File uploads are currently not configured. You can
                              still submit your application, and files can be
                              uploaded later through your profile settings.
                            </p>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className='w-full h-48 bg-gray-100 rounded-lg flex items-center justify-center'>
                            <div className='text-center'>
                              ...
                              <p className='text-xs text-gray-500'>
                                {(videoIntro.size / (1024 * 1024)).toFixed(1)}{' '}
                                MB
                              </p>
                            </div>
                          </div>
                    ...
                    <div className='space-y-3'>
                      ...
                      <p className='text-sm text-gray-600'>
                        Upload certificates, diplomas, or other relevant
                        documents
                      </p>
                    ...
                    <FormField
                      ...
                      render={() => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Share your interests to help students connect with
                            you
                          </FormDescription>
                          <div className='grid grid-cols-2 md:grid-cols-4 gap-3 mt-2 max-h-48 overflow-y-auto'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <div className='bg-slate-50 p-4 rounded-lg'>
                      ...
                      <ul className='text-sm text-blue-800 space-y-1'>
                        <li>
                          • Your application will be reviewed within 2-3
                          business days
                        </li>
                        <li>
                        ...
                        <li>
                          • Approved teachers get access to the full dashboard
                          and can start teaching
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className='bg-green-50 p-4 rounded-lg'>
                      ...
                      <p className='text-sm text-green-800 mb-4'>
                        ...
                        You can edit most details later in your profile.
                      </p>
