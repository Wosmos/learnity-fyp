...
> = ({ userRole, onResendVerification, onBackToLogin, className = '' }) => {
    ...
    switch (userRole) {
      case UserRole.STUDENT:
        return {
          ...
          description:
            'Welcome to Learnity! Please verify your email to start learning.',
          nextSteps: [
      ...
      case UserRole.TEACHER:
        return {
          ...
          description:
            'Thank you for applying to teach on Learnity. Please verify your email first.',
          nextSteps: [
            'Check your email inbox for a verification link',
          ...
          {userRole === UserRole.TEACHER && (
            <div className='bg-green-50 border border-green-200 rounded-lg p-4'>
              ...
              <p className='text-sm text-green-700 mt-1'>
                Once you verify your email, our team will review your teaching
                credentials and qualifications. You'll be notified via email
