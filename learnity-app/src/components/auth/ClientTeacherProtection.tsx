...
export function ClientTeacherProtection({
  children,
}: ClientTeacherProtectionProps) {
      ...
      if (firebaseUser) {
        try {
          ...
          if (
            ...
            console.log(
              'Access denied - User is not a teacher or admin, role:',
              role
            );
 ...
 */
function TeacherUnauthorizedFallback({
  userRole,
}: {
