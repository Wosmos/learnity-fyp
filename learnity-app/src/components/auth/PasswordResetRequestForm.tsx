...
import { passwordResetRequestSchema, type PasswordResetRequestData } from '@/lib/validators/auth';
import { KeyRound, Mail, ArrowLeft, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
        ...
        <div className={`w-full max-w-md mx-auto ${className}`}>
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-3 pt-4">
              ...
              <Button onClick={onBackToLogin} className="w-full bg-slate-600 hover:bg-slate-700">
