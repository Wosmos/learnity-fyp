    ...
    <div className={cn('w-full max-w-2xl mx-auto px-6 py-12', className)}>
                ...
                <div className='flex-1 space-y-4'>
                  ...
                  <div className='flex flex-wrap gap-x-6 gap-y-2 pt-2'>
                    {option.features.map(feature => (
                      <span
                        key={feature}
                        className='flex items-center text-[9px] font-black uppercase tracking-[0.2em] text-slate-600 group-hover:text-slate-500 transition-colors'
                      >
      ...
      <div className='mt-12 text-center'>
        <p className='text-[10px] font-black uppercase tracking-[0.3em] text-slate-600'>
          ...
          <Link
            href='/auth/login'
            className='hover:text-slate-300 underline underline-offset-8 decoration-white/20 hover:decoration-white transition-all'
          >
            Login
          </Link>
        </p>
