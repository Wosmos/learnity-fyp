...
import { BookOpen, GraduationCap, Star, Users, Quote, CheckCircle2 } from 'lucide-react';
    ...
    <div className={cn(
      ...
      <div className="relative z-10 animate-in fade-in slide-in-from-top-4 duration-700">
        <Link href="/" className="flex items-center space-x-3 w-fit group">
          ...
          <span className="text-xl font-bold tracking-tighter text-white">Learnity</span>
        </Link>
      </div>
