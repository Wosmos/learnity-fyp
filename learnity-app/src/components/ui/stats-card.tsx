...
export function MetricCard({
  ...
  const variants = {
    ...
    modern: "bg-white border-none shadow-xl shadow-slate-200/60 text-slate-900 hover:shadow-indigo-100",
          ...
          <div className="w-12 md:w-20 h-6 md:h-10 opacity-60 group-hover:opacity-100 transition-opacity">
            <svg viewBox="0 0 100 40" className="w-full h-full overflow-visible">
              ...
              <circle
                ...
                r="3"
                fill="currentColor"
                className={cn("hidden md:block animate-ping", isTrendUp ? "text-emerald-400" : "text-rose-400")}
              />
            </svg>
            </div>
          </div>
