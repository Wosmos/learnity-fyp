      ...
      <div className="relative h-full bg-white rounded-[2.5rem] border border-slate-100 p-8 transition-all duration-500 hover:border-slate-900 hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)] flex flex-col">
        ...
        <div className="flex justify-between items-start mb-8">
          ...
          <div className="text-right">
            <p className="text-[10px] font-black text-slate-300 uppercase tracking-widest mb-1">Rate</p>
            <p className="text-xl font-black text-slate-900 tracking-tighter italic">
              ${teacher.hourlyRate}<span className="text-[10px] font-bold text-slate-400">/hr</span>
            </p>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {teacher.subjects.slice(0, 2).map((subject, index) => (
              <span key={index} className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                {subject}
              </span>
            ))}
          </div>
        ...
        <div className="flex items-center gap-6 py-4 border-y border-slate-50 mb-6">
          <div>
            <div className="flex items-center gap-1 text-amber-500 mb-0.5">
              <span className="text-sm font-black italic">{rating.toFixed(1)}</span>
              <Star className="w-3 h-3 fill-current" />
            </div>
            <p className="text-[9px] font-bold text-slate-300 uppercase tracking-[0.1em]">{teacher.reviewCount} Reviews</p>
          </div>
          <div className="w-px h-8 bg-slate-100" />
          <div>
            <p className="text-sm font-black text-slate-900 italic mb-0.5">{teacher.experience}Y</p>
            <p className="text-[9px] font-bold text-slate-300 uppercase tracking-[0.1em]">Experience</p>
          </div>
        </div>
        ...
        <div className="mt-auto flex items-center justify-between group/btn">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-900">View Dossier</span>
