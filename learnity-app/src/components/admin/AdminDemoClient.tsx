    ...
    try {
      ...
      for (const event of testEvents) {
        try {
          ...
          setResults(prev => [
            ...prev,
            `❌ Error generating ${event.description}`,
          ]);
        }
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            This demo generates test audit events to showcase the audit logging
            system. Click the button below to generate sample events, then view
            them in the Audit Logs section.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {results.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Status of test event generation</CardDescription>
          </CardHeader>
          <CardContent>
