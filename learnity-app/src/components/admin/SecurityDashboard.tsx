...
import { AlertTriangle, Shield, Eye, Ban, Download } from 'lucide-react';
                ...
                <div key={index} className='border rounded-lg p-4'>
                  ...
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                    ...
                    <div>
                      ...
                      <span className='ml-1 font-medium'>
                        {pattern.ipAddresses.length}
                      </span>
                    </div>
                    <div>
                      <span className='text-muted-foreground'>Users:</span>
                      <span className='ml-1 font-medium'>
                        {pattern.affectedUsers.length}
                      </span>
                    </div>
                    <div>
                      ...
                      <span className='ml-1 font-medium'>
                        {formatDistanceToNow(
                          new Date(pattern.timeRange.startDate)
                        )}
                      </span>
                    </div>
                  </div>
            ...
            <div className='space-y-4'>
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  <p className='text-2xl font-bold'>
                    {stats.failedLoginAnalysis.totalFailedLogins}
                  </p>
                ...
                <div>
                  <p className='text-2xl font-bold'>
                    {stats.failedLoginAnalysis.uniqueIpAddresses}
                  </p>
                  <p className='text-xs text-muted-foreground'>
                    Unique IP Addresses
                  </p>
              ...
              <div>
                ...
                <div className='space-y-2'>
                  {stats.failedLoginAnalysis.topFailureReasons
                    .slice(0, 5)
                    .map((reason, index) => (
                      <div
                        key={index}
              ...
              {stats.summary.topIpAddresses.slice(0, 8).map((ip, index) => (
                <div key={index} className='flex justify-between items-center'>
                  ...
                  <div className='text-right'>
                    ...
                    <div className='text-xs text-muted-foreground'>
                      {formatDistanceToNow(new Date(ip.lastSeen), {
                        addSuffix: true,
                      })}
                    </div>
                  </div>
