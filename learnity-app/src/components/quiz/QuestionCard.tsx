...
export function QuestionCard({
  ...
  const optionStyles = {
    default:
      'border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-blue-600 hover:bg-slate-50 dark:hover:bg-slate-900/20',
    selected:
      'border-blue-500 bg-slate-50 dark:bg-slate-900/30 ring-2 ring-blue-500/20',
    correct:
  ...
  const isCorrectAnswer =
    showFeedback && hasAnswered && selectedOption === correctOptionIndex;
      ...
      <CardContent className='space-y-4'>
        ...
        <div className='space-y-3'>
          {options.map((option, index) => {
            ...
            const isCorrect =
              showFeedback && hasAnswered && index === correctOptionIndex;
            const isWrong =
              showFeedback &&
              hasAnswered &&
              isSelected &&
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  optionStyles[state],
                  (isLoading || (showFeedback && hasAnswered)) &&
