...
export function QuizResultsPage({
  ...
  return (
    <div
      className={cn(
        'min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 py-8',
        className
      )}
    >
      <div className='max-w-4xl mx-auto px-4'>
        ...
        <div className='flex flex-col sm:flex-row gap-3 mb-8'>
          ...
          <Link
            href={`/courses/${courseId}/learn/${lessonId}`}
            className='flex-1'
          >
        ...
        {!result.isCorrect && (
          <div className='flex items-start gap-2'>
            ...
            <span className='text-sm text-green-700 dark:text-green-300'>
              {String.fromCharCode(65 + result.correctOptionIndex)}.{' '}
