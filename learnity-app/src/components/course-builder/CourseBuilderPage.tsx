...
export function CourseBuilderPage({ courseId }: CourseBuilderPageProps) {
  ...
  const sectionsComplete =
    sections.length > 0 && sections.some(s => s.lessons.length > 0);
      ...
      <main className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        >
          <TabsList className='grid w-full grid-cols-3 lg:w-auto lg:inline-grid bg-white shadow-sm border'>
            <TabsTrigger
              value='basic-info'
              className='gap-2 data-[state=active]:bg-slate-50'
            >
          ...
          <TabsContent value='basic-info' className='space-y-6'>
            <Card className='border-0 shadow-md'>
              <CardHeader>
                ...
                <CardDescription>
                  Set up the basic details for your course. This information
          ...
          <TabsContent value='sections' className='space-y-6'>
            <Card className='border-0 shadow-md'>
              <CardHeader>
                ...
                <CardDescription>
                  Organize your course into sections and add lessons. You can
...
function StepIndicator({
  ...
  status: 'pending' | 'complete' | 'error' | 'ready';
}) {
  switch (status) {
    case 'complete':
    case 'ready':
