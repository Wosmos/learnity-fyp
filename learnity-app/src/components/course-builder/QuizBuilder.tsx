...
export function QuizBuilder({ sectionIndex, lessonIndex, onClose }: QuizBuilderProps) {
  ...
  const handleSaveQuestion = () => {
    ...
    const cleanedData = {
      ...
      correctOptionIndex: Math.min(data.correctOptionIndex, cleanedOptions.length - 1),
    };
    ...
    if (index === null) {
      ...
      setQuiz(prev => ({
        ...prev,
        questions: [...prev.questions, { ...cleanedData, order: prev.questions.length }],
      }));
    } else {
      // Update existing question
      setQuiz(prev => ({
        ...prev,
        questions: prev.questions.map((q, i) => i === index ? cleanedData : q),
      }));
    }
  ...
  const handleRemoveOption = (optionIndex: number) => {
    ...
    const newOptions = editingQuestion.data.options.filter((_, i) => i !== optionIndex);
    const newCorrectIndex = editingQuestion.data.correctOptionIndex >= optionIndex
    ...
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create questions for this quiz. Students need {quiz.passingScore}% to pass.
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setQuiz(prev => ({ 
                  ...prev, 
                  passingScore: Math.min(100, Math.max(1, parseInt(e.target.value) || 70))
                }))}
              />
            </div>
          </div>
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          <Button
                            ...
                            onClick={() => setEditingQuestion({ index, data: { ...question } })}
                          >
        ...
        {editingQuestion && (
          <Dialog open onOpenChange={() => setEditingQuestion(null)}>
            <DialogContent className="max-w-lg">
              <DialogHeader>
                <DialogTitle>
                  {editingQuestion.index === null ? 'Add Question' : 'Edit Question'}
                </DialogTitle>
              </DialogHeader>
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-3">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={(v) => setEditingQuestion({
                      ...editingQuestion,
                      data: { ...editingQuestion.data, correctOptionIndex: parseInt(v) },
                    })}
                  >
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setEditingQuestion({
                      ...editingQuestion,
                      data: { ...editingQuestion.data, explanation: e.target.value },
                    })}
              ...
              <DialogFooter>
                ...
                <Button
                  ...
                  disabled={
                    ...
                    editingQuestion.data.options.filter(o => o.trim()).length < 2
                  }
                >
                  {editingQuestion.index === null ? 'Add Question' : 'Save Question'}
                </Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
