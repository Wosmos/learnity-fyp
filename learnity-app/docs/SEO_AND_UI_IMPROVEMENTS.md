...
- Image: 1200x630px (Facebook/LinkedIn optimal size)
- URL: Canonical URL
...
- **Trust-building**: Social proof and trust indicators
...
- **Better typography**: Larger headings, improved line height
...
- **Two clear CTAs**: Find your tutor / Sign In
...
- **Clean bottom bar**: Logo, copyright, status indicator
- **Removed clutter**: No tech badges, cleaner design
...
4. Add FAQ schema
5. Create subject-specific landing pages
